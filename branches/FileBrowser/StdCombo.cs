...
namespace prototype.Create_Open_add
{
    #region ComboBox
    ...
    /// ShellItems.
    /// </summary>
    public class StdComboBox : ComboBox
    {
        #region Fields
        ...
        public StdComboBox()
        {
            ...
            HandleCreated += new EventHandler(ComboBox_HandleCreated);

            MouseDown += new MouseEventHandler(ComboBox_MouseDown);
            MouseMove += new MouseEventHandler(ComboBox_MouseMove);
            MouseClick += new MouseEventHandler(ComboBox_MouseClick);

            DropDown += new EventHandler(ComboBox_DropDown);
        }
        ...
        protected override void OnSelectedIndexChanged(EventArgs e)
        {
            ...
            if (SelectedIndex > -1)
                currentItem = SelectedItem as BrowserComboItem;
        }
        ...
        public class ComboEditWindow : NativeWindow
        {
            private const int LEFTMARGIN = 0x1;
            private StdComboBox owner;
