namespace primeira.pNeuron
{
    partial class TopologyToolbox
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btDelNeuron = new primeira.pNeuron.EditorBaseButton();
            this.btAddSynapse = new primeira.pNeuron.EditorBaseButton();
            this.btAddNeuron = new primeira.pNeuron.EditorBaseButton();
            this.btCursor = new primeira.pNeuron.EditorBaseButton();
            this.SuspendLayout();
            // 
            // btDelNeuron
            // 
